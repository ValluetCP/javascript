...
//Prenom = "Mila";
// entre les guillemets ce sont des chaînes de caractères,
// chaîne de caractère (string) = c'est le type de la variable
// = ce sont des caractères alphabétiques ou numérique
// 
